-------------------------------------------------------------------------------
-- Script       : 418_evaluate_models_svm_unigram_fs.sql
...
---------------------------------------------------------------------------------
-- Test Data labelled using Unigram SVM Model with Feature Selection
...
---------------------------------------------------------------------------------
DROP TABLE IF EXISTS car_complaints.nhtsa_1gram_fs_svm_output;

-------------------------------------------------------------------------------
-- Train SVM classifier model 
-- @input		: complaints.nhtsa_test_1gram_tfidf_fs
-- @input		: complaints.nhtsa_1gram_fs_svm_model
-- @output		: complaints.nhtsa_1gram_fs_svm_output
...
FROM   SPARSESVMPREDICTOR(
                           ON (SELECT 1)
                           PARTITION BY 1
                           INPUTTABLE('car_complaints.nhtsa_test_1gram_tfidf_fs')
                           MODELTABLE('car_complaints.nhtsa_1gram_fs_svm_model')
                           OUTPUTTABLE('car_complaints.nhtsa_1gram_fs_svm_output')
...
---------------------------------------------------------------------------------
-- Confusion matrix evaluation of Unigram SVM Model with Feature Selection
...
-- @row 		: accuracy
---------------------------------------------------------------------------------
DROP TABLE IF EXISTS car_complaints.nhtsa_1gram_fs_svm_metrics;

-------------------------------------------------------------------------------
-- Create confusion matrix to evaluate SVM prediction
-- @input		: complaints.nhtsa_test
-- @input		: complaints.nhtsa_1gram_fs_svm_output
-- @output		: complaints.nhtsa_1gram_fs_svm_metrics
...
FROM   CONFUSIONMATRIXPLOT(
                            ON (
                                 ...
                                 FROM CONFUSIONMATRIX(
                                                       ON (
                                                            ...
                                                            INNER JOIN car_complaints.nhtsa_1gram_fs_svm_output 
                                                                       classify 
                            ...
                            PARTITION BY 1
                            OUTPUTTABLE('car_complaints.nhtsa_1gram_fs_svm_metrics')
                            BETA(1.0)
                          );
                          
-------------------------------------------------------------------------------
-- Display the evaluation criteria for this model
-- @input		: car_complaints.nhtsa_1gram_fs_svm_metrics
-- @output		: accuracy
-- @output		: precision
-- @output		: recall
-- @output 		: f-measure
-------------------------------------------------------------------------------                           
SELECT * FROM car_complaints.nhtsa_1gram_fs_svm_metrics;       
