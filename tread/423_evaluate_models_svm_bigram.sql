-------------------------------------------------------------------------------
-- Script       : 423_evaluate_models_svm_bigram.sql
...
---------------------------------------------------------------------------------
-- Test Data labelled using Bigram SVM Model
...
---------------------------------------------------------------------------------
DROP TABLE IF EXISTS car_complaints.nhtsa_2gram_svm_output;

-------------------------------------------------------------------------------
-- Train SVM classifier model 
-- @input		: car_complaints.nhtsa_test_2gram_tfidf
-- @input		: car_complaints.nhtsa_2gram_svm_model
-- @output		: car_complaints.nhtsa_2gram_svm_output
...
FROM   SPARSESVMPREDICTOR(
                           ON (SELECT 1)
                           PARTITION BY 1
                           INPUTTABLE('car_complaints.nhtsa_test_2gram_tfidf')
                           MODELTABLE('car_complaints.nhtsa_2gram_svm_model')
                           OUTPUTTABLE('car_complaints.nhtsa_2gram_svm_output')
...
---------------------------------------------------------------------------------
-- Confusion matrix evaluation of Bigram SVM Model
...
-- @row 		: accuracy
---------------------------------------------------------------------------------
DROP TABLE IF EXISTS car_complaints.nhtsa_2gram_svm_metrics;

-------------------------------------------------------------------------------
-- Script       : CONFUSIONMATRIXPLOT
-- Purpose      : Create confusion matrix to evaluate SVM prediction
-- @input		: car_complaints.nhtsa_test
-- @input		: car_complaints.nhtsa_2gram_svm_output
-- @output		: car_complaints.svm_nhtsa_2gram_plot
...
FROM   CONFUSIONMATRIXPLOT(
                            ON (
                                 ...
                                 FROM CONFUSIONMATRIX(
                                                       ON (
                                                            ...
                                                            INNER JOIN car_complaints.nhtsa_2gram_svm_output classify 
                            ...
                            PARTITION BY 1
                            OUTPUTTABLE('car_complaints.nhtsa_2gram_svm_metrics')
                            BETA (1.0)
                          );
                           
-------------------------------------------------------------------------------
-- Display the evaluation criteria for this model
-- @input		: car_complaints.nhtsa_2gram_svm_metrics
-- @output		: accuracy
-- @output		: precision
-- @output		: recall
-- @output 		: f-measure
-------------------------------------------------------------------------------                           
SELECT * FROM car_complaints.nhtsa_2gram_svm_metrics;       
