-------------------------------------------------------------------------------
-- Script       : 417_train_models_svm_unigram_fs.sql
...
---------------------------------------------------------------------------------
DROP TABLE IF EXISTS car_complaints.nhtsa_1gram_fs_svm_model;

-------------------------------------------------------------------------------
-- Train SVM classifier model with Feature Selection
-- @input		: car_complaints.nhtsa_train_1gram_tfidf_fs
-- @output		: car_complaints.nhtsa_1gram_fs_svm_model
...
FROM   SPARSESVMTRAINER(
                         ON (SELECT 1)
                         PARTITION BY 1
                         INPUTTABLE('car_complaints.nhtsa_train_1gram_tfidf_fs')
                         MODELTABLE('car_complaints.nhtsa_1gram_fs_svm_model')
