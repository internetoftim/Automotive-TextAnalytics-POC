-------------------------------------------------------------------------------
-- Script       : 621_create_visuals_unigram.sql
...
FROM VISUALIZER(
                 ON (
                      SELECT *
                      FROM car_complaints.nhtsa_engine_1gram_cfilter 
...
---------------------------------------------------------------------------------
-- Script to be loaded to APPCenter
-- Create sigma graph for CFilter output of ENGINE TREAD bucket using reduced
-- feature set
-- Take note of the memory limitation of appcenter. You may have to reduce
-- the data size by performing feature selection
-- @param       : ORDER BY support DESC - Rank them based on the 'support',
...
FROM VISUALIZER(
                 ON (
                      SELECT *
                      FROM car_complaints.nhtsa_engine_1gram_cfilter_fs 
                      ORDER BY support DESC
                      LIMIT 100000  
                    )
                 PARTITION BY 1 
...
---------------------------------------------------------------------------------
-- Script to be loaded to APPCenter
-- Create sigma graph for CFilter output of BRAKES TREAD bucket 
-- Take note of the memory limitation of appcenter. You may have to reduce
-- the data size by performing feature selection
-- @param       : ORDER BY support DESC - Rank them based on the 'support',
--                'lift', 'confidence' (in this case, we used 'support')
...
FROM VISUALIZER(
                 ON (
                      SELECT *
                      FROM car_complaints.nhtsa_brakes_1gram_cfilter 
                      ORDER BY support DESC
                      LIMIT 100000  
                    )
                 PARTITION BY 1 
...
---------------------------------------------------------------------------------
-- Script to be loaded to APPCenter
-- Create sigma graph for CFilter output of BRAKES TREAD bucket using reduced
-- feature set
-- Take note of the memory limitation of appcenter. You may have to reduce
-- the data size by performing feature selection
-- @param       : ORDER BY support DESC - Rank them based on the 'support',
...
FROM VISUALIZER(
                 ON (
                      SELECT *
                      FROM car_complaints.nhtsa_brakes_1gram_cfilter_fs 
                      ORDER BY support DESC
                      LIMIT 100000  
                    )
                 PARTITION BY 1 
